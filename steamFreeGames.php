...
include "apikey.php";
session_start();
$steamLibrary = file_get_contents("http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001?key={$apikey}&steamid=76561198257023366&include_appinfo=1&include_played_free_games=1");
$buffer       = fopen("cache/games/76561198257023366.json", "w+");
fwrite($buffer, $steamLibrary);
fclose($buffer);
$gameLibraryRetrieve = file_get_contents("http://thewheelhaus.com/cache/games/76561198257023366.json");
